...
<body>
    <br>
    <h1 class="text-center" style="font-family :'Times New Roman', Times, serif; margin-bottom: 10px;"><b>PENILAIAN
            SISWA</b></h1>
    <div class="container mt-5 d-flex justify-content-center">
        <form action="proses_edit_nilai.php" method="post">
            <div class="form-group">
                <label for="id">ID Data:</label>
                <input type="text" class="form-control" id="id" name="id" required placeholder="masukkan ID data yang akan diubah">
            </div>
